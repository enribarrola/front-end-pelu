...
function Paginacion() {
	const {servicio_clientes,setPaginaActual} = useStore()

	function next(){
		setPaginaActual(servicio_clientes.page + 1)
  ...
  return (
	<nav aria-label="Page navigation example">
				<ul className="inline-flex -space-x-px text-base h-10">
					<li>
						<button href="#" className="flex items-center justify-center px-4 h-10 ms-0 leading-tight text-gray-500 bg-white border border-e-0 border-gray-300 rounded-s-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white" onClick={next}>Previous</button>
					</li>
					<li>
